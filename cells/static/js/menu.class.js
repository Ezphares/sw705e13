...
Menu.prototype.draw_startmenu = function(gl)
{
	...
	this.draw_button(false, 'Editor', 0, gl.height/2+105, gl);
};

Menu.prototype.draw_singleplayermenu = function(gl)
{
	this.draw_background(gl);
	this.draw_button(true, 'Challenges', 0, gl.height/2-105, gl);
...
{
	this.draw_background(gl);
	this.draw_button(true, '1', 0, gl.height/2-105, gl);
	this.draw_button(true, '2', 0, gl.height/2-35, gl);
	this.draw_button(true, '3', 0, gl.height/2+35, gl);
	this.draw_button(true, '4', 0, gl.height/2+105, gl);
	gl.draw_sprite(this.spr_back, 0, 0, gl.height-(this.spr_back.frame_height));
	gl.draw_sprite(this.spr_home, 0, 40, gl.height-(this.spr_home.frame_height));
};
...
Menu.prototype.draw_skirmishmenu = function(gl)
{
	...
	this.draw_button(true, 'Import', 0, gl.height/2-35, gl);
	gl.draw_sprite(this.spr_back, 0, 0, gl.height-(this.spr_back.frame_height));
	gl.draw_sprite(this.spr_home, 0, 40, gl.height-(this.spr_home.frame_height));
};
