 ...
 * @see {Sprite}
 */
Board2 = function(size)
{
	this.size = size;
	this.spr_tile = Board2.tile;
	this.entities = [];
...
Board2.prototype.init = function(cell1, cell2)
{
 ...
 */
Board2.prototype.draw = function(gl)
{
	...
	if(cell_red_hp != 0 || cell_green_hp != 0){
		...
		gl.draw_sprite(Board2.health_green_start, 0, 0, 0);
		for(var i = 16; i < count; i+=16) {
			gl.draw_sprite(Board2.health_green_mid, 0, i, 0);
		}
	
		for(var i = count; i < gl.width; i+=16) {
			gl.draw_sprite(Board2.health_red_mid, 0, i, 0);
		}
	
		gl.draw_sprite(Board2.health_red_end, 0, gl.width-16, 0);
	}
};

Board2.prototype.health_count = function(green_hp, red_hp) 
{
 ...
 */
Board2.prototype.update = function()
{
	// TODO: Spawn food?
 ...
 * @see {Cell}
 */
Board2.prototype.add_entity = function(entity)
{
 ...
 * @see {Cell}
 */
Board2.prototype.remove_entity = function(entity)
{
...
Board2.prototype.isDone = function()
{
	var friends = 0;
	var enemies = 0;
...
Board2.prototype.playerWins = function()
{
	var enemies = 0;
...
Board2.load_sprites = function(gl, callback)
{
	...
	{
		Board2.tile = sprites[0];
		Board2.health_green_start = sprites[1];
		Board2.health_green_mid   = sprites[2];
		Board2.health_red_mid   = sprites[3];
		Board2.health_red_end     = sprites[4];
