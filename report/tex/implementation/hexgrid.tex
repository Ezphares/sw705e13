...
The function \verb|get_tile_position| serves this purpose, and the calculation is a bit more involved than going the other way around.\todo{What other way around?}
The chosen way of implementing this is using two points, called low and high, which both start set to the origin.\todo{Question: what is start set?}
