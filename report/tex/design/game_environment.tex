...
Programming the cell should be intuitive\todo{To Martin: Intuitive better than inviting?} to the user, and not be the cause of frustration due to the occurrence of peculiar programming-oriented errors, they will be tasked to dealing with.
