...
This project should focus on teaching a single subject.\todo{Done}
	...
	For this reason our game will be a 2D game without focus on good graphics.\todo{Done}
	...
	This type of realistic situation should be included in the game as well.\todo{Not done at all}
	\item The browser-based games in general are very explicit in their intend to teach.
	It is a requirement, that our game avoids this issue, since our idea is to teach people basic programming constructs without explicitly stating "now you are learning!".\todo{What have we done to avoid this?}
	...
	The level of qualification the players have at the start is considered basic at best, therefore a higher level of abstraction is necessary to successfully teach.\todo{Done. Drag-and-drop and avoiding making the player write code directly avoid the low level of abstraction.}
	...
	This ensures that the program they write is easier to understand, but the program editor as well works in a predictable way.\todo{Done? We allow if-statements and branching, but we clearly depict where the program will continue, so maybe this is done.}
\end{itemize}
...
\begin{itemize}
	...
	Either AI or multiplayer should be implemented to make the game playable.\todo{Well I guess it has to be AI}
