...
This project should focus on teaching a single subject.\todo{Fulfilled}
	...
	For this reason our game will be a 2D game without focus on good graphics.\todo{Fulfilled}
	...
	This type of realistic situation should be included in the game as well.\todo{Not fulfilled}
	...
	The level of qualification the players have at the start is considered basic at best, therefore a higher level of abstraction is necessary to successfully teach.\todo{Fulfilled. Drag-and-drop and avoiding making the player write code directly avoid the low level of abstraction.}
	...
	This ensures that the program they write is easier to understand, but the program editor as well works in a predictable way.\todo{Fulfilled? We allow if-statements and branching, but we clearly depict where the program will continue, so maybe this is done.}
\end{itemize}
